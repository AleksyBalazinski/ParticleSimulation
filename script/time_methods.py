...
# Example usage:
# plot_pm()  # PM CPU vs GPU plot
# plot_bh()
# plot_single('p3m_time.txt', "P3M Simulation Runtime per Iteration (CPU)", color='blue', fit_quadratic=True)
plot_single('pp_time.txt', "P3M Simulation Runtime per Iteration (CPU)", color='blue', fit_quadratic=True)